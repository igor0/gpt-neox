...
def main():
    ...
    parser.add_argument("--mode", type=str, default=None, choices=['logit_lens', 'extra_linear', 'final_linear', 'final_norm', 'out_linear_all', 'in_linear_all', 'all', 'all_100k', 'pre_logit_lens', 'pre_extra_linear'])
